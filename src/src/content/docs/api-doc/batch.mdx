...
An adjunct batch represents a submitted job of adjuncts. [Collections](../collections) of batches are returned from:

- `/customers/{customer}/adjuntQueue/batches`
- `/customers/{customer}/adjuntQueue/active`
- `/customers/{customer}/adjuntQueue/recent`
...
{
    "@context": "https://dlcs.github.io/vocab/context/future.json",
    "@id": "https://api.dlcs.example/customers/2/adjuntQueue/batches/875629",
    ...
    "errors": 0,
    "superseded": false,
    "currentAdjuncts": "https://api.dlcs.example/customers/2/adjuntQueue/batches/875629/current",
    "adjuncts": "https://api.dlcs.example/customers/2/adjuntQueue/batches/875629/adjuncts",
    "completedAdjuncts": "https://api.dlcs.example/customers/2/adjuntQueue/batches/875629/completed",
    "errorAdjuncts": "https://api.dlcs.example/customers/2/adjuntQueue/batches/875629/error"
}
```

`/customers/{customer}/adjuntQueue/batches/{batch}`
...
A link to a Collection of all the adjuncts _currently_ in the batch, defined as all the adjuncts that have _this_ batch as their [batch](../adjunct#batch) property at time of request.

| domain | range | readonly | writeonly |
|:---|:---|:---|:---|
| vocab:Space | 🔗 hydra:Collection (of vocab:Adjunct) | True | False |
...
A link to a Collection of all the assets in the batch at the point the batch was created, _as long as they are still present in the system and have not been deleted_. Many batches can include the same adjunct in this property, whereas only one batch can include an adjunct in its [images](#currentAdjuncts) property.

| domain | range | readonly | writeonly |
|:---|:---|:---|:---|
| vocab:Space | 🔗 hydra:Collection (of vocab:Adjunct) | True | False |

`/customers/{customer}/adjunctQueue/batches/{batchId}/assets`

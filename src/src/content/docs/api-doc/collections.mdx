...
<Aside type="note">
  For IIIF Collections, see _IIIF Manifests and Collections_ (documentation forthcoming).
</Aside>
...
```json
{
    ...
    "member": [
        {
            "@id": "https://api.dlcs.example/customers/99/spaces/33/images/PHOTO.2.22.36.2.tif",
            "@type": "vocab:Image",
        ...
        {
            "@id": "https://api.dlcs.example/customers/99/spaces/33/images/amb.jpg",
            "@type": "vocab:Image",
            "id": "amb.jpg",
    ...
    "view": {
        "@id": "https://api.dlcs.example/customers/99/spaces/33/images?page=2&pageSize=2",
        "@type": "PartialCollectionView",
        "first": "https://api.dlcs.example/customers/99/spaces/33/images?page=1&pageSize=2",
        "previous": "https://api.dlcs.example/customers/99/spaces/33/images?page=1&pageSize=2",
        "page": 2,
        "pageSize": 2,
        "totalPages": 2
    }
...
In some cases, you as the API consumer will supply a collection - you POST a collection of images to your customer [queue](../queues), e.g., at /customers/34/queue. Here, you would construct a Hydra Collection as the JSON payload of your POST.

...
An array of strings where the strings are URIs of [Roles](../access-control#roles) belonging to the customer.

These are the default [Roles](../access-control#roles) for assets in this space.

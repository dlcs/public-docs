...
<Card title="Sample code" icon="seti:python">
    Each page of the API documentation is accompanied by 💻 <a href="https://github.com/dlcs/public-docs/blob/main/dlcs-docs-client">sample Python code</a>.<br/>
...
<LinkCard
  title="💻 Example: Navigating the API"
  href="https://github.com/dlcs/public-docs/blob/main/dlcs-docs-client/p01_overview/overview.py"
  description="An example showing navigation from the API root"
/>
...
Many users will prefer to think of the platform not as Assets in Spaces, but as IIIF Manifests that have Assets. See _IIIF Manifests and Collections_ (documentation forthcoming).
...
<Card title="Sample code" icon="seti:python">
    💻 <a href="https://github.com/dlcs/public-docs/blob/main/dlcs-docs-client">sample Python code</a>.<br/>
    The samples use deliberately simple IIIF-CS Client helpers.
</Card>

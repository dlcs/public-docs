...
The value of `maxWidth` must either be `0`, indicating unset (a system default will still be imposed) or a positive integer equal to or greater that `256`. Values between 0 and 256 exclusive are disallowed.
